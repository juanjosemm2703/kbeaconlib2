...
class CfgHTHistoryController : UIViewController,UITableViewDataSource, UITableViewDelegate
{
    ...
    override func viewDidLoad() {
        ...
        self.mTableView.refreshControl = rc
        ...
        self.mTableView.refreshControl!.attributedTitle =
            NSAttributedString(string: NSLocalizedString("ACTION_REFRESHING", comment:""))
        self.mTableView.refreshControl!.layoutIfNeeded()
    ...
    {
        if (self.mTableView.refreshControl!.isRefreshing)
        {
            self.mTableView.refreshControl!.attributedTitle =
                NSAttributedString(string: NSLocalizedString("ACTION_REFRESHING", comment:""))
    ...
    func showNoMoreDataMessage(_ readNum: Int)
    {
        ...
        self.mTableView.refreshControl!.attributedTitle = NSAttributedString(string: NSLocalizedString("PUSH_TO_RELEASE", comment:""))
    }
