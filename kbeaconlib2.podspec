...
Pod::Spec.new do |s|
  s.name             = 'kbeaconlib2'
  s.version          = '1.0.1'
  s.summary          = 'init version of kbeaconlib2.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/kkmhogen/ios_kbeaconlib2'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liushax@gmail.com' => 'liushax@gmail.com' }
  s.source           = { :git => 'https://github.com/kkmhogen/ios_kbeaconlib2.git', :tag => s.version.to_s }
